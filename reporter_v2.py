...
# All openpyxl imports are deferred until first use
Font = PatternFill = Alignment = Border = Side = get_column_letter = Workbook = None
_xl_ready = False

def _init_xl():
    global Font, PatternFill, Alignment, Border, Side, get_column_letter, Workbook, _xl_ready, BORDER
    if _xl_ready:
        return
    from openpyxl import Workbook as _WB
    from openpyxl.styles import Font as _F, PatternFill as _PF, Alignment as _AL, Border as _B, Side as _S
    from openpyxl.utils import get_column_letter as _GCL
    Font = _F; PatternFill = _PF; Alignment = _AL; Border = _B; Side = _S
    get_column_letter = _GCL; Workbook = _WB
